      ...
      {beneficiary ? (
        <div className="w-full max-w-xl bg-white shadow-lg rounded-lg p-6 mt-6">
          ...
          <select
            ...
            className="w-max px-4 py-2 border rounded-lg shadow-sm focus:ring focus:ring-green-300"
          >
          ...
          <button
            ...
            disabled={loading}
            className="w-full mt-4 text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5"
          >
